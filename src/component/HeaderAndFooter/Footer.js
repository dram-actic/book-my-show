...
import careLogo from "./customerCareLogo.png";
...
function Footer() {
    ...
    return (
        <>
            <footer class="flex flex-col items-center gap-8 bg-[#333338] text-[#cdcdcd]">
                <div className="flex flex-col items-center w-full bg-[#404043]">
                    <img className="w-20" src={careLogo} alt={"LOGO"} />
                    <div className="text-[#BCC0C4] cursor-default">24/7 Customer Care </div>
                </div>
                <div className="flex flex-col items-center w-full " >
                    <div className="font-semibold text-[#BCC0C4] text-xl">Help</div>
